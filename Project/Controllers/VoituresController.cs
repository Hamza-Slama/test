...
namespace CarsMVCManager.Controllers
{
    ...
    {
        private CrasModelContainer db = new CrasModelContainer();
        ...
        public ActionResult Create([Bind(Include = "Id,Matricule,Marque,Couleur,Carburant,DateMC,Modele,ProprietaireId")] Voiture voiture)
        { if (voiture.Marque == 0) ModelState.AddModelError("Marque ", "Veuillez saisir une marque !");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Matricule,Marque,Couleur,Carburant,DateMC,Modele,ProprietaireId")] Voiture voiture)
        {
            if (ModelState.IsValid)
            {
